...
func TestOIDC_AuthorizeRenew(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := tt.prov.AuthorizeRenew(context.TODO(), tt.args.cert)
			if (err != nil) != tt.wantErr {
...
func TestOIDC_AuthorizeSSHRevoke(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := tt.prov.AuthorizeSSHRevoke(context.TODO(), tt.args.token)
			if (err != nil) != tt.wantErr {
...
func TestOIDC_AuthorizeSSHRenew(t *testing.T) {
	type test struct {
		p     *OIDC
		token string
		code  int
...
func TestOIDC_AuthorizeSSHRekey(t *testing.T) {
	type test struct {
		p     *OIDC
		token string
		code  int
